//FaBo JetRacer v3.8
//2023/08/30
//切り替えノイズ対策実施、ドンキーカーモード削除

//（作業者に重要)レビションやファームウェアバージョンによって以下を変更すること。
#define FIRMWARE_NUMBER    38     //Firmware Version 3.8
#define BOARDMAJOR         2      //基板版数パッチメジャー
#define BOARDMINOR         0      //基板版数パッチマイナー
#define BOARDPATCH         30     //基板版数パッチRev2.0.30は30
...
//ピンセッティング
...
#elif BOARDPATCH == 27 || BOARDPATCH == 28 || BOARDPATCH == 29
  #define ST_SIGNAL_INPUT_PIN       A0
  #define TH_SIGNAL_INPUT_PIN       A1
  #define FSW_SIGNAL_INPUT_PIN      A3
  #define SELECT_OUTPUT_PIN         2
  ...
  #define MODE_SWITCH_INPUT_PIN     5   //JetRacer mode or Donkey mode.
  #define DMODE_LED_PIN             9   //Donkey mode led pin.
  #define TACKT_SWITCH_INPUT_PIN    6   //TACKTSWICH
...
void loop(){
 ...
 //ドンキーモードありのボード(v3.8よりプロポレスモード機能削除)
 #if BOARDPATCH >= 17
